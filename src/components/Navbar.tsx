...
const Navbar = () => {
  ...
  const { isAdminLoggedIn, logoutAdmin, currentStudent, logoutStudent } =
    useApp();
          ...
          {currentStudent ? (
            <div className="relative">
              ...
              >
                ...
                <ChevronDown
                  size={12}
                  className={`transition-transform duration-200 ${studentMenuOpen ? "rotate-180" : ""}`}
                />
              </button>
              {studentMenuOpen && (
            ...
            {currentStudent ? (
              <>
                ...
                <Link
                  to="/dashboard"
                  onClick={() => setMobileOpen(false)}
                  className="block rounded-lg px-3 py-2.5 text-sm text-foreground hover:bg-muted/50 transition-colors"
                >
                  My Dashboard
                </Link>
                <button
                  ...
                  className="block w-full text-left rounded-lg px-3 py-2.5 text-sm text-destructive hover:bg-destructive/10 transition-colors"
                >
                  Sign Out
                </button>
              </>
              ...
              <Link
                to="/student/login"
                onClick={() => setMobileOpen(false)}
                className="block rounded-lg px-3 py-2.5 text-sm font-medium text-foreground hover:bg-muted/50 transition-colors"
              >
                Student Login
              </Link>
            )}
